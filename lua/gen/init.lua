...
local default_options = {
    ...
    scratchpad_filename = function() return M.prompts_dir .. "/Scratchpad.prompts.md" end,
    scratchpad_layout = {},
}
...
-- This group will be cleared once when the plugin is loaded (see the "GenTransient" group).
